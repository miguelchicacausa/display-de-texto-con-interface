 ...
 */
public class TLetter extends Letter{
	/**
	 * constructor de la clase
	 * @param parameters
	 */
	public TLetter(Parameters parameters) {
		super(parameters);
	}
	/**
	...
	/**
	 * metodo que limpia la matriz y luego genera una matriz de caracteres en forma de la letra T
	 */
